...
export default function SearchCabs() {
    ...
    useEffect(() => {
        ...
        async function fetchLocations() {
            const result = await axios.get('https://cab-system-api.onrender.com/api/locations');
        ...
        async function getDistances() {
            const result = await axios.get('https://cab-system-api.onrender.com/api/distances');
